...
export const TRAVEL_TOLERANCE = 1;
export const MAX_DEVIANCE = 2; // maximal sum of incidence angles (in degrees) before we use the 'travel' function to compute the arrowhead shape
