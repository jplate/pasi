        ...
        <div className="flex flex-col h-full">
            <div className="grid grid-cols-2">
                <span className="col-span-2 my-1.5">
                    <InputField
                        label="Fontsize correction"
                        value={displayFontFactor}
                        step={0.01}
                        onChange={changeDFF}
                        tooltip={
                            <>
                                Adjust this value to increase or decrease the fontsize of any labels displayed on the canvas. (Some adjustment may be needed to
                                make the labels&apos; appearance match the LaTeX output more closely.)
                            </>
                        }
                ...
                <CheckBoxField
                    label="Snap to contour centers"
                    style="col-span-2 mb-1 px-4 py-1 text-base"
                    value={grid.snapToContourCenters}
                    onChange={changeSnapToCC}
                />
            ...
            <div className="flex-1"> {/* some filler to push the button to the bottom */}</div>
