    ...
    return (
        <div className='flex flex-col h-full'>
            <div className='grid grid-cols-2'>
                ...
                <CheckBoxField label='Snap to contour nodes' style='col-span-2 mt-2 px-4 py-2 text-base' value={grid.snapToNodes} onChange={changeSnapToNode} />
                <CheckBoxField label='Snap to contour centers' style='col-span-2 mt-1 mb-2 px-4 py-2 text-base' value={grid.snapToContourCenters} onChange={changeSnapToCC} />
