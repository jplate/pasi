    ...
    return (
        <div className='flex flex-col h-full'>
            <div className='grid grid-cols-2'>
                ...
                <CheckBoxField
                    label='Snap to node centers'
                    style='col-span-2 mt-2 px-4 py-1 text-base'
                    value={grid.snapToNodes}
                    onChange={changeSnapToNode}
                />
                <CheckBoxField
            ...
            <BasicColoredButton
                id='reset-button'
                label='Defaults'
                style='px-2 mx-2 mb-2 col-span-2 rounded-lg text-sm'
                disabled={false}
                onClick={reset}
            />
        </div>
